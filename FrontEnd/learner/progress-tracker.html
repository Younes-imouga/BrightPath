...
<head>
  ...
  <title>BrightPath - Progress Tracker</title>
...
<body class="bg-gray-100 text-gray-800">
  ...
  <main class="container mx-auto p-4">
    <section class="bg-white rounded-lg shadow p-8 my-8 text-center">
      <h2 class="text-2xl text-blue-500 font-bold mb-4">Your Progress</h2>
      <p class="text-lg text-gray-600 mb-2">Course: Programming Basics — 40% completed</p>
      <p class="text-lg text-gray-600 mb-2">Course: Mathematics for School — 70% completed</p>
      <!-- More progress details as needed -->
    </section>
  </main>
