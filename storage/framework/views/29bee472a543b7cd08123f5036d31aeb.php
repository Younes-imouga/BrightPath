...
<head>
  ...
  <title>BrightPath - Course Content</title>
...
<body class="bg-gray-100 text-gray-800">
  ...
  <main class="container mx-auto p-4">
    <section class="bg-white rounded-lg shadow p-8 my-8">
      <h2 class="text-3xl text-blue-500 font-bold mb-4">Programming Basics - Lesson 1: Introduction</h2>
      <p class="text-gray-600 mb-4">
        Welcome to your first lesson! In this lesson, you will learn the fundamentals of programming and what to expect from this course.
      </p>
      <button onclick="alert('Proceed to next lesson...')" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        Next Lesson
      </button>
    </section>
  </main>
...
<?php /**PATH C:\Users\LENOVO\Desktop\BrightPath\resources\views/student/courseContent.blade.php ENDPATH**/ ?>