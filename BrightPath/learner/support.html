...
<head>
  ...
  <title>BrightPath - Support</title>
...
<body class="bg-gray-100 text-gray-800">
  ...
  <main class="container mx-auto p-4">
    <section class="max-w-lg mx-auto bg-white rounded-lg shadow p-8 my-8">
      <h2 class="text-2xl text-blue-500 font-bold mb-4 text-center">Submit a Support Request</h2>
