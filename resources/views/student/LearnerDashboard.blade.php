    ...
    <section class="my-12">
      ...
      <div class="grid md:grid-cols-3 gap-10">
        <div class="bg-white rounded-xl shadow-lg p-8 text-center border-l-4 border-blue-400 transition-transform transform hover:scale-105 hover:shadow-2xl duration-200">
          ...
          <button onclick="window.location.href='{{ route('student.myCourses') }}'" class="bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-bold py-2 px-6 rounded-lg shadow transition duration-200">
            My Courses
          </button>
        </div>
        <div class="bg-white rounded-xl shadow-lg p-8 text-center border-l-4 border-blue-400 transition-transform transform hover:scale-105 hover:shadow-2xl duration-200">
          ...
          <button onclick="window.location.href='{{ route('student.courses') }}'" class="bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-bold py-2 px-6 rounded-lg shadow transition duration-200">
            All Courses
          </button>
        </div>
        <div class="bg-white rounded-xl shadow-lg p-8 text-center border-l-4 border-blue-400 transition-transform transform hover:scale-105 hover:shadow-2xl duration-200">
          ...
          <button onclick="window.location.href='{{ route('student.progress') }}'" class="bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-bold py-2 px-6 rounded-lg shadow transition duration-200">
            View Progress
          </button>
        </div>
      </div>
